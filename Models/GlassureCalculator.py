...
class GlassureCalculator(object):
    def __init__(self, original_spectrum, background_spectrum,  elemental_abundances, density,
        ...
        self.sample_spectrum = self.original_spectrum - background_spectrum
...
class StandardCalculator(GlassureCalculator):
    def __init__(self, original_spectrum, background_spectrum, elemental_abundances, density,
        ...
        super(StandardCalculator, self).__init__(original_spectrum, background_spectrum, elemental_abundances,
                                                 density, r)
