...
#
# Created: Wed Oct  1 18:17:54 2014
...
""))
        ...
        self.gridLayout_2.setContentsMargins(5, 8, 5, 5)
        self.gridLayout_2.setObjectName(_fromUtf8("gridLayout_2"))
        self.density_txt = QtGui.QLineEdit(self.groupBox_3)
        self.density_txt.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.density_txt.setObjectName(_fromUtf8("density_txt"))
        self.gridLayout_2.addWidget(self.density_txt, 2, 1, 1, 1)
        self.composition_tw = QtGui.QTableWidget(self.groupBox_3)
        self.composition_tw.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.composition_tw.setColumnCount(2)
        self.composition_tw.setObjectName(_fromUtf8("composition_tw"))
        self.composition_tw.setRowCount(0)
        self.composition_tw.horizontalHeader().setVisible(False)
        self.composition_tw.horizontalHeader().setDefaultSectionSize(90)
        self.composition_tw.verticalHeader().setVisible(False)
        self.gridLayout_2.addWidget(self.composition_tw, 1, 0, 1, 2)
        self.delete_element_btn = QtGui.QPushButton(self.groupBox_3)
        self.delete_element_btn.setFlat(True)
        self.delete_element_btn.setObjectName(_fromUtf8("delete_element_btn"))
        self.gridLayout_2.addWidget(self.delete_element_btn, 0, 1, 1, 1)
        self.add_element_btn = QtGui.QPushButton(self.groupBox_3)
        self.add_element_btn.setFlat(True)
        self.add_element_btn.setObjectName(_fromUtf8("add_element_btn"))
        self.gridLayout_2.addWidget(self.add_element_btn, 0, 0, 1, 1)
    ...
    def retranslateUi(self, MainWidget):
        ...
        self.density_txt.setText(_translate("MainWidget", "2.1", None))
        self.delete_element_btn.setText(_translate("MainWidget", "Delete", None))
        self.add_element_btn.setText(_translate("MainWidget", "Add", None))
        self.label_4.setText(_translate("MainWidget", "Density:", None))
