...
class GlassureFunctionalTest(unittest.TestCase):
    ...
    def test_normal_workflow(self):
        ...
        prev_sq_data = self.widget.spectrum_widget.sq_items[0].getData()
        prev_gr_data = self.widget.spectrum_widget.gr_items[0].getData()
        ...
        self.assertFalse(np.array_equal(prev_sq_data, self.widget.spectrum_widget.sq_items[0].getData()))
        self.assertFalse(np.array_equal(prev_gr_data, self.widget.spectrum_widget.gr_items[0].getData()))
        ...
        self.assertTrue(np.array_equal(prev_sq_data, self.widget.spectrum_widget.sq_items[0].getData()))
        self.assertFalse(np.array_equal(prev_gr_data, self.widget.spectrum_widget.gr_items[0].getData()))
        ...
        self.assertLess(self.widget.spectrum_widget.sq_items[0].getData()[0][0], 0.5)
